...
import { addTransaction, deleteTransaction, getTransactions, importTransactions } from "../controllers/transactionController.js";
...
router.post('/import-csv',apiLimiter, verifyJWT, importTransactions);
